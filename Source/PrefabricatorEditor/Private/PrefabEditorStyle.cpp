...
TSharedRef< class FSlateStyleSet > FPrefabEditorStyle::Create()
{
	...
	// Generic styles
	{
		...
		Style.Set("Prefabricator.CreatePrefabFromParent", new IMAGE_PLUGIN_BRUSH("PrefabTool/Icons/Icon_Prefab_48", Icon48x48));
		Style.Set("Prefabricator.CreatePrefabFromParent.Small", new IMAGE_PLUGIN_BRUSH("PrefabTool/Icons/Icon_Prefab_16a", Icon16x16));
